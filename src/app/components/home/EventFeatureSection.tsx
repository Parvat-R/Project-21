...
import { eventFeatures } from "@/assests/dummyData/eventFeatures";
    ...
    <section className="bg-gray-100 py-24 px-6">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative space-y-8">
          {/* Background Circle */}
          <div className="absolute -left-20 top-10 w-[420px] h-[420px] bg-orange-200 rounded-full opacity-40 blur-2xl"></div>
